...
router.post('/absences', role('TEACHER'), validate(absenceSchema), controller.createAbsence);
router.post('/grades', role('TEACHER'), validate(gradeSchema), controller.createGrade);
...
router.get('/students/:studentId/dashboard', role('PARENT', 'STUDENT', 'ADMIN'), controller.dashboard);
